var vm = new Vue({
    el: "#wrap",
    data: {
        sort_data: { pjInfoList: [], success_count: 6 }
    },
    methods: {
        getMenu: function(cb) {
            //加载菜单树
            $.get("../pjinfo/sucselect", function(r) { // 获取选择列表
        ...
        getdata:function(){
        	 $.get("../pjinfo/pjsucsortlist", function(r) {
        		 vm.sort_data.pjInfoList = r.pjInfoList
        		 vm.sort_data.success_count = r.success_count
             });
        },
