...
<%
	...
	String referrer = FString.toString(request.getParameter("referrer"), ""); 
%>
<head>
    <meta charset="UTF-8">
    ...
    <div id="wrap">
        ...
        <div class="float">
            ...
            <div class="cert-float active">
                ...
                <p>本平台所展示的项目信息来自于融资公司、领投人等机构提供的信息资料，融资公司、领投人对其提供信息的真实可靠性和完整准确性负责。本平台提供的宣传推介材料仅供投资者参考，不构成本平台的任何推荐或投资建议。投资者应审慎决策、独立承担风险。</p>
                <a href="/login.html<%=referrer.equals("") ? "" : "?referrer="+referrer%>">登录</a>
            </div>
        </div>
    </div>
</body>
