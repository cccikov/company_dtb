<!DOCTYPE html>
<%@page import="io.renren.utils.ResultInfo"%>
<html lang="zh">
...
<%
	...
	ResultInfo resultInfo = request.getAttribute("resultInfo") != null ? (ResultInfo)request.getAttribute("resultInfo"):null;
%>
